...
class VoiceServerUpdate extends Event<Events.VoiceServerUpdate> {
    run: SupportEventCallback<Events.VoiceServerUpdate> = (packet) => {
        db.adapter.onVoiceServer({...packet, guild_id: packet.guildId});
    };
}
 ...
 */
export default [VoiceStateUpdate, VoiceServerUpdate];
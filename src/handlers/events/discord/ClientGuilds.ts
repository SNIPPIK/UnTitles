...
class GuildCreate extends Event<Events.GuildCreate> {
    run: SupportEventCallback<Events.GuildCreate> = (guild) => {
...
class GuildRemove extends Event<Events.GuildDelete> {
    run: SupportEventCallback<Events.GuildDelete> = async (guild) => {

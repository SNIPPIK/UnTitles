 ...
 *
 *
 * @license BSD-3 | Эта команда защищена лицензией проекта, изменение или удаление без письменного разрешения строго запрещено!!!
 */
@CommandDeclare({
    names: {
        "en-US": "report",
...
class ReportCommand extends Assign< BaseCommand<any> > {
    public constructor() {
        super({
            permissions: {

                ...
                switch (type) {
                    ...
                    case "join": {
                        ...
                        // Подключаемся к голосовому каналу без очереди
                            ...
                            db.voice.join({ channel_id: VoiceChannel.id, guild_id: guild.id, self_deaf: false, self_mute: true }, (message.client as DiscordClient).adapter.createVoiceAdapter(guildId));
                        }

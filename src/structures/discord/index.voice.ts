import { VoiceAdapters, DiscordGatewayAdapterLibraryMethods} from "#core/voice/transport/adapter.js";
 ...
 */
export class SeyfertVoice<T extends DiscordClient = DiscordClient> extends VoiceAdapters<DiscordClient> {
